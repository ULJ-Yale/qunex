...
commands = {'listDicom'            : {'com': g_dicom.listDicom,              'args': ('folder', )},
            ...
            'runNILFolder'         : {'com': g_4dfp.runNILFolder,            'args': ('folder', 'pattern', 'overwite', 'sessionfile')},
            'runNIL'               : {'com': g_4dfp.runNIL,                  'args': ('folder', 'overwite', 'sessionfile')},
            ...
            'createSessionInfo'    : {'com': g_utilities.createSessionInfo,  'args': ('sessions', 'pipelines', 'subjectsfolder', 'sourcefile', 'targetfile', 'mapping', 'filter', 'overwrite')},
            'printniftihdr'        : {'com': g_img.printniftihdr,            'args': ('filename', )},
            'modniftihdr'          : {'com': g_gimg.modniftihdr,             'args': ('filename', 's')},
            'createBatch'          : {'com': g_utilities.createBatch,        'args': ('subjectsfolder', 'sourcefiles', 'targetfile', 'sessions', 'filter', 'overwrite', 'paramfile')},
            'createStudy'          : {'com': g_utilities.createStudy,        'args': ('studyfolder', 'folders', )},
            'createList'           : {'com': g_utilities.createList,         'args': ('subjectsfolder', 'sessions', 'filter', 'listfile', 'bolds', 'conc', 'fidl', 'glm', 'roi', 'boldname', 'boldtail', 'overwrite', 'check')},
            'createConc'           : {'com': g_utilities.createConc,         'args': ('subjectsfolder', 'sessions', 'filter', 'concfolder', 'concname', 'bolds', 'boldname', 'boldtail', 'overwrite', 'check')},
            'gatherBehavior'       : {'com': g_utilities.gatherBehavior,     'args': ('subjectsfolder', 'sessions', 'filter', 'sourcefiles', 'targetfile', 'overwrite', 'check', 'report')},
            'pullSequenceNames'    : {'com': g_utilities.pullSequenceNames,  'args': ('subjectsfolder', 'sessions', 'filter', 'sourcefiles', 'targetfile', 'overwrite', 'check', 'report')},
            'batchTag2NameKey'     : {'com': g_utilities.batchTag2NameKey,   'args': ('filename', 'sessionids', 'bolds', 'output', 'prefix')},
            'exportHCP'            : {'com': ge_HCP.exportHCP,               'args': ('subjectsfolder', 'sessions', 'filter', 'sessionids', 'mapaction', 'mapto', 'overwrite', 'mapexclude', 'hcp_suffix', 'verbose')},
            'mapIO'                : {'com': ge_HCP.exportHCP,               'args': ('subjectsfolder', 'sessions', 'filter', 'sessionids', 'mapaction', 'mapto', 'overwrite', 'mapexclude', 'hcp_suffix', 'verbose')},
...
extraParameters = ['sessions', 'filter', 'sessionids', 'scheduler', 'parelements', 'scheduler_environment', 'scheduler_workdir', 'scheduler_sleep', 'nprocess', 'logfolder', 'basefolder', 'subjectsfolder', 'sperlist', 'runinpar', 'ignore']
