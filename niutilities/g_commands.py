...
commands = {'listDicom'            : {'com': g_dicom.listDicom,              'args': ('folder', )},
            ...
            'createSessionInfo'    : {'com': g_utilities.createSessionInfo,  'args': ('sessions', 'pipeline', 'subjectsfolder', 'sfile', 'tfile', 'mapping', 'sfilter', 'overwrite')},
            'printniftihdr'        : {'com': g_img.printniftihdr,            'args': ('filename', )},
            'modniftihdr'          : {'com': g_gimg.modniftihdr,             'args': ('filename', 's')},
            'createBatch'          : {'com': g_utilities.createBatch,        'args': ('subjectsfolder', 'pipeline', 'sfile', 'tfile', 'sessions', 'sfilter', 'overwrite', 'paramfile')},
            'createStudy'          : {'com': g_utilities.createStudy,        'args': ('studyfolder', 'pipeline', )},
            ...
            'exportHCP'            : {'com': ge_HCP.exportHCP,               'args': ('subjectsfolder', 'sessions', 'sfilter', 'subjid', 'mapaction', 'mapto', 'overwrite', 'mapexclude', 'hcp_suffix', 'verbose')},
            'mapIO'                : {'com': ge_HCP.exportHCP,               'args': ('subjectsfolder', 'sessions', 'sfilter', 'subjid', 'mapaction', 'mapto', 'overwrite', 'mapexclude', 'hcp_suffix', 'verbose')},
