...
commands = {'listDicom'            : {'com': g_dicom.listDicom,              'args': ('folder', )},
            ...
            'HCPLSImport'          : {'com': g_hcpls.HCPLSImport,            'args': ('subjectsfolder', 'inbox', 'sessions', 'action', 'overwrite', 'archive', 'hcplsname', 'nameformat', 'filesort')},
            ...
            'setupHCP'             : {'com': g_HCP.setupHCP,                 'args': ('sfolder', 'tfolder', 'sfile', 'check', 'existing', 'filename', 'folderstructure', 'hcpsuffix')},
            ...
            'mapIO'                : {'com': g_utilities.mapIO,              'args': ('subjectsfolder', 'sessions', 'sfilter', 'subjid', 'maptype', 'mapaction', 'mapfrom', 'mapto', 'overwrite', 'mapexclude', 'hcpsuffix', 'verbose')},
