...
commands = {'listDicom'            : {'com': g_dicom.listDicom,              'args': ('folder', )},
            ...
            'processInbox'         : {'com': g_dicom.processInbox,           'args': ('subjectsfolder', 'sessions', 'masterinbox', 'check', 'pattern', 'nameformat', 'tool', 'cores', 'logfile', 'archive', 'options', 'unzip', 'gzip', 'verbose')},
            ...
            'setupHCP'             : {'com': g_HCP.setupHCP,                 'args': ('sfolder', 'tfolder', 'sfile', 'check', 'existing', 'boldnamekey')},
