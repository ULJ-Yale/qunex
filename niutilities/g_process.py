...
arglist = [['# ---- Basic settings'],
           ...
           ['hcp_gdcoeffs',           'NONE',                                     str,    "Location of gradient coefficient file, a string describing mulitiple options, or 'NONE' to skip"],
           ...
           ['hcp_mcsigma',            '14.14213562373095048801',                  str,    "Correction sigma used for metric smooting [sqrt(200)]."],
