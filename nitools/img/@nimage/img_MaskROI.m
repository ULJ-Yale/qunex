...
for n = 1:nroi
    ...
    %   rmask = roi2.img_ROIMask(img.roi.roicodes2{n});
    if length(img.roi.roicodes2{n}) == 0
        rmask = img.img_ROIMask(img.roi.roicodes(n));
    else
        rmask = img.img_ROIMask(img.roi.roicodes(n)) & roi2.img_ROIMask(img.roi.roicodes2{n});
    end
