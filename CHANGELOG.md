...
Environment status script now works properly, upgraded the automatic setting of parallelism parameters and the default value setting in HCP TaskfMRIAnalysis pipeline. Fixed BIDS import.
