...
%   aparc or aparc+aseg segmentation in the same resolution as the bold files. Do
%   note that these should be NIfTI files as most often signal from ventricles and
...
%
%   *elements*
%   Either a structure or a well formed string that can be processed using the 
%   g_ParseOptions function that specifies what should be plotted. Please see 
%   documentation for g_PlotBoldTS for detailed information on how to specify plot
%   elements. The default string is:
%
...
%
%   This creates a document with a single stats plot that includes frame displacement
%   and dvarsme statistics for the first image, ventricle, white matter, and gray 
%   matter plots for the first image, each scaled individually, and ventricle and 
%   gray matter plots for the second image, with bad frames masked and scaled to the 
...
%
%   An example with bold1.nii.gz as the first file, 'QA_' as value of the filename
%   parameter, and 'pdf' as the value of fformat parameter would be:
%
%   QA_bold1_tsplot.pdf
%
%   *fformat*
...
%
%   *skip*
%   If no initial dummy scans were used during image acquisition, the number of
%   frames to skip from the start of the bold image. 0 by default.
%
%   *verbose+
%   Whether to provide a report of what is being done while the function is running.
%   False by default.
%
%   EXAMPLE USE
%
%   g_PlotBoldTSList('bolds.list', [], 'QA_', 5, 'png', true);
%
%   ——————————————————
