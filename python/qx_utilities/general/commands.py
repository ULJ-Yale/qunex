...
commands = {'list_dicom'            : {'com': dicom.list_dicom,               'args': ('folder', )},
            ...
            'create_list'           : {'com': utilities.create_list,          'args': ('sessionsfolder', 'sessions', 'filter', 'listfile', 'bolds', 'conc', 'fidl', 'glm', 'roi', 'boldname', 'bold_tail', 'img_suffix', 'bold_variant', 'overwrite', 'check')},
            'create_conc'           : {'com': utilities.create_conc,          'args': ('sessionsfolder', 'sessions', 'filter', 'concfolder', 'concname', 'bolds', 'boldname', 'bold_tail', 'img_suffix', 'bold_variant', 'overwrite', 'check')},
            ...
            'get_sessions_for_slurm_array' : {'com': utilities.get_sessions_for_slurm_array, 'args': ('sessions')}, 
            }
