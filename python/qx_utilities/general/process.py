...
arglist = [
    ...
    ["hcp_msmall_module_name", "", isNone],
    ["hcp_msmall_iteration_modes", "", isNone],
    ["hcp_msmall_method", "", isNone],
    ["hcp_msmall_use_migp", "", flag],
    ["hcp_msmall_ica_dim", "", isNone],
    ["hcp_msmall_low_sica_dims", "", isNone],
    ["hcp_msmall_vn", "", flag],
    ["hcp_msmall_reg_conf_path", "", isNone],
    ["hcp_msmall_reg_vars", "", isNone],
    ["hcp_msmall_rsn_template", "", isNone],
    ["hcp_msmall_rsn_weights", "", isNone],
    ["hcp_msmall_topography_roi", "", isNone],
    ["hcp_msmall_topography_target", "", isNone],
    ["hcp_msmall_no_ind_mean", "", flag],
    ["hcp_msmall_start_frame", "", isNone],
    ["hcp_msmall_end_frame", "", isNone],
...
calist = [
    ...
    ["hcp_transmit_bias_individual_adjustment",process_hcp.hcp_transmit_bias_individual_adjustment],
