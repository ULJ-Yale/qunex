...
arglist = [
           ...
           ['hcp_task_lvl2task', 'NONE',                                          str, "Name of Level2 subdirectory in which all Level2 feat directories are written for TaskName."],
           ['hcp_task_lvl2fsf', '',                                               isNone, "Prefix of design.fsf filename for the Level2 analysis for TaskName."],
           ['hcp_task_confound', 'NONE',                                          str, "Confound matrix text filename (e.g., output of fsl_motion_outliers)."],
           ['hcp_bold_final_smoothFWHM', '2',                                     str, "Value (in mm FWHM) of total desired smoothing."],
           ['hcp_task_highpass', '200',                                           str, "Apply additional highpass filter (in seconds) to time series and task design."],
           ['hcp_task_lowpass', 'NONE',                                           str, "Apply additional lowpass filter (in seconds) to time series and task design."],
           ['hcp_task_procstring', 'NONE',                                        str, "String value in filename of time series image."],
           ['hcp_task_parcellation', 'NONE',                                      str, "Name of parcellation scheme to conduct parcellated analysis."],
           ['hcp_task_parcellation_file', 'NONE',                                 str, "Absolute path to the parcellation dlabel."],
           ['hcp_task_vba',               'FALSE',                                torf, "VBA YES/NO."],
