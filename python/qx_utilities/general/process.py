...
arglist = [
    ...
    ["hcp_prefs_species", "", is_none],
    ["hcp_prefs_runmode", "", is_none],
    ["hcp_prefs_truepatientposition", "", is_none],
    ["hcp_prefs_scannerpatientposition", "", is_none],
    ["hcp_prefs_betcenter", "", is_none],
    ["hcp_prefs_betradius", "", is_none],
    ["hcp_prefs_betfraction", "", is_none],
    ["hcp_prefs_bettop2center", "", is_none],
    ["hcp_prefs_brainextract", "", is_none],
    ["hcp_prefs_use_t2w_phase_zero", "", is_none],
    ["hcp_prefs_bias_field_sigma_no_t2w", "", is_none],
    ["hcp_prefs_betbiasfieldcor", "", is_none],
