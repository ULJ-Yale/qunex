...
arglist = [
    ...
    [
        ...
        "",
        flag,
        "Set this flag to use wb command to do volume resampling instead of applywarp.",
    ],
    [
        "hcp_echo_te",
        "",
    ...
    [
        ...
        "",
        isNone,
        "The clean mode substring, can be 'clean' as sICA+FIX cleaned,'clean_rclean' as sICA+FIX cleaned and reclean.",
    ],
    ["# --- hcp_icafix options"],
    [
    ...
    [
        ...
        "BUILTIN",
        str,
        "Parallelization execution mode, one of FSLSUB, BUILTIN, NONE. Default is BUILTIN.",
    ],
    ...
    ["hcp_transmit_mode", "", isNone, "What type of transmit bias correction to apply."],
    ["hcp_gmwm_template", "", isNone, "Location of the GMWMtemplate, the file containing GM+WM volume ROI."],
    ["hcp_group_corrected_myelin", "", isNone, "The group-corrected myelin file from AFI or B1Tx."],
    ["hcp_afi_image", "", isNone, "Two-frame AFI image."],
    ["hcp_afi_tr_one", "", isNone, "TR of first AFI frame."],
    ["hcp_afi_tr_two", "", isNone, "TR of second AFI frame."],
    ["hcp_afi_angle", "", isNone, "Target flip angle of AFI sequence."],
    ["hcp_b1tx_magnitude", "", isNone, "B1Tx magnitude image (for alignment)."],
    ["hcp_b1tx_phase", "", isNone, "B1Tx phase image."],
    ["hcp_b1tx_phase_divisor", "", isNone, "What to divide the phase map by to obtain proportion of intended flip angle [800]."],
    ["hcp_pt_fmri_names", "", isNone, "A comma separeted list of fmri runs to use SE/SBRef files from."],
    ["hcp_pt_bbr_threshold", "", isNone, "Mincost threshold for reinitializing fMRI bbregister with flirt (may need to be increased for aging-related reduction of gray/white contrast) [0.5]."],
    ["hcp_myelin_template", "", isNone, "Expected transmit-corrected group-average myelin pattern (for testing correction parameters)."],
    ["hcp_group_uncorrected_myelin", "", isNone, "The group-average uncorrected myelin file (to set the appropriate scaling of the myelin template)."],
    ["hcp_pt_reference_value_file", "", isNone, "Text file containing the value in the pseudotransmit map where the flip angle best matches the intended angle, from the Phase2 group script."],
    ["hcp_unproc_t1w_list", "", isNone, "A comma separated list of unprocessed T1w images, for correcting non-PSN data."],
    ["hcp_unproc_t2w_list", "", isNone, "A comma separated list of unprocessed T2w images, for correcting non-PSN data."],
    ["hcp_receive_bias_body_coil", "", isNone, "Image acquired with body coil receive, to be used with --hcp_receive_head_body_coil."],
    ["hcp_receive_bias_head_coil", "", isNone, "Matched image acquired with head coil receive."],
    ["hcp_raw_psn_t1w", "", isNone, "The bias-corrected version of the T1w image acquired with pre-scan normalize, which was used to generate the original myelin maps."],
    ["hcp_raw_nopsn_t1w", "", isNone, "The uncorrected version of the --raw-psn-t1w image."],
    ["hcp_transmit_res", "", isNone, "Resolution to use for transmit field, default equal to hcp_grayordinatesres."],
    ["hcp_myelin_mapping_fwhm", "", isNone, "The fwhm value to use in -myelin-style [5]."],
    ["hcp_old_myelin_mapping", "", flag, "If myelin mapping was done using version 1.2.3 or earlier of wb_command, set this flag."],
...
calist = [
    ...
    ["hpctbi", "hcp_transmit_bias_individual", process_hcp.hcp_transmit_bias_individual, "Run HCP Transmit Bias Individual Only pipeline."],
