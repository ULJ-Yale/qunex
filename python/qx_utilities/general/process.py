...
arglist = [
    ...
    ['lopass_do',           'nuisance,movement,events,task',               str,    "What to low-pass filter besides BOLD signal"],    
    ...
    ['hcp_topupconfig',        'NONE',                                     str, "A full path to the topup configuration file to use. Set to '' if the default is to be used or of TOPUP distortion correction is not used."],
    ...
    ['hcp_bold_topupconfig',   '',                                         isNone, "A full path to the topup configuration file to use. Do not set if the default is to be used or if TOPUP distortion correction is not used."],
    ...
    ['hcp_dwi_topupconfig',   '',                                          isNone, "A full path to the topup configuration file to use. Set to '' if the default is to be used or of TOPUP distortion correction is not used."],
    ...
    ['hcp_tica_stop_after_step', 'ComputeTICAFeatures',                    str,     "What step to stop processing after, same valid values as for hcp_tica_starting_step."],
...
flaglist = [
    ...
    ['fix_no_motion_cleanup',       'fix_no_motion_cleanup',        True,   "Provide this to disable cleanup of motion confounds."],
