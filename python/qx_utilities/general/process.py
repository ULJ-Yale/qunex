...
arglist = [
    ...
    [
        ...
        "",
        isNone,
        "Whether to execute only the FIX step of the pipeline and reuse previous ICA results.",
    ],
    [
        "hcp_fix_backup",
        "",
    ...
    [
        ...
        "",
        isNone,
        "Start stage for certain HCP pipelines that can be processed in stages.",
    ],
    [
        "hcp_end_stage",
        "",
        isNone,
        "End stage for certain HCP pipelines that can be processed in stages.",
    ],
    ...
    [
        ...
        "",
        isNone,
        "What type of transmit bias correction to apply.",
    ],
    [
        "hcp_gmwm_template",
        "",
    ...
    [
        ...
        "",
        isNone,
        "What to divide the phase map by to obtain proportion of intended flip angle [800].",
    ],
    [
        "hcp_pt_fmri_names",
        "",
        isNone,
        "A comma separeted list of fmri runs to use SE/SBRef files from.",
    ],
    [
        "hcp_pt_bbr_threshold",
        "",
        isNone,
        "Mincost threshold for reinitializing fMRI bbregister with flirt (may need to be increased for aging-related reduction of gray/white contrast) [0.5].",
    ],
    [
        "hcp_myelin_template",
        "",
    ...
    [
        ...
        "",
        isNone,
        "A comma separated list of unprocessed T1w images, for correcting non-PSN data.",
    ],
    [
        "hcp_unproc_t2w_list",
        "",
        isNone,
        "A comma separated list of unprocessed T2w images, for correcting non-PSN data.",
    ],
    [
    ...
    ["# --- hcp_hippunfold and hcp_post_hippunfold options"],
    [
        "hcp_hippunfold_dir",
        "",
        isNone,
...
calist = [
    ...
    ["hcpa", "hcp_asl", process_hcp.hcp_asl, "Run HCP ASL pipeline."],
    [
        "hcptbi",
        "hcp_transmit_bias_individual",
        process_hcp.hcp_transmit_bias_individual,
        "Run HCP Transmit Bias Individual Only pipeline.",
    ],
    [
        "hcp_hu",
        "hcp_hippunfold",
        process_hcp.hcp_hippunfold,
        "Run the HCP Hippunfold pipeline.",
    ],
    [
        "hcc_phu",
        "hcc_post_hippunfold",
        process_hcp.hcp_post_hippunfold,
        "Run the HCP Post Hippunfold pipeline.",
    ],
    [],
