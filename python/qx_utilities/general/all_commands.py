...
all_qunex_commands = [
    ...
    (
        "qx_utilities.processing.rapidtide.rapidtide",
        "Runs rapidtide feat command.",
        "python",
    ),
    (
    ...
    (
        "qx_mri.fc.fc_compute_gbc",
        "Computes Global Brain Connectivity (GBC) maps.",
        "matlab",
    ),
    (
    ...
    (
        ...
        "Computes ROI functional connectivity matrices.",
        "matlab",
    ),
    (
        "qx_mri.fc.fc_compute_seedmaps",
        "Computes seed based functional connectivity maps.",
        "matlab",
    ),
    (
        "qx_mri.fc.fc_extract_roi_timeseries",
        "Extracts and saves region timeseries using the provided ROI specification.",
        "matlab",
    ),
    (
    ...
    (
        "qx_mri.general.general_create_roi",
        "Creates ROI image file based on the provided specification.",
        "matlab",
    ),
    (
    ...
    (
        "qx_utilities.hcp.process_hcp.hcp_long_post_freesurfer",
        "Runs the longitudinal HCP Post FreeSurfer pipeline.",
        "python",
    ),
    (
        "qx_utilities.hcp.process_hcp.hcp_long_msmall",
        "Runs the longitudinal HCP MSMAll pipeline.",
        "python",
    ),
    (
    ...
    (
        "qx_utilities.hcp.process_hcp.hcp_transmit_bias_individual",
    ...
    (
        "qx_utilities.hcp.process_hcp.hcp_transmit_bias_group_average_fit",
