...
def hcp_freesurfer(sinfo, options, overwrite=False, thread=0):
    ...
    log = SessionLog(sinfo, options, "HCP FreeSurfer Pipeline", tail="\n", lead="\n\n")
    ...
    try:
        pc.do_options_check(options, sinfo, "hcp_freesurfer")
        do_hcp_options_check(options, "hcp_freesurfer")
