...
echo "$Caret7_Command -probtrackx-dot-convert ${Dir}/fdt_matrix${MatrixNumber}.dot ${Dir}/fdt_matrix"$MatrixNumber".dconn.nii -row-surface ${Dir}/SeedSpaceMetric.func.gii -col-surface ${Dir}/SeedSpaceMetric.func.gii -transpose ${MakeSymmetric}"
...
#echo "$Caret7_Command -convert-matrix4-to-workbench-sparse ${Dir}/fdt_matrix4_1.mtx ${Dir}/fdt_matrix4_2.mtx ${Dir}/fdt_matrix4_3.mtx ${BedpostXFolder}/Whole_Brain_Trajectory_${DiffusionResolution}.fiberTEMP.nii ${Dir}/tract_space_coords_for_fdt_matrix4 -surface-seeds ${Dir}/SeedSpaceMetric.func.gii ${Dir}/fdt_matrix4.trajTEMP.wbsparse"
