...
usage() {
 ...
 echo ""
 echo " <study_folder>/<case>/hcp/<case>/T1w/Diffusion"
 echo ""
 ...
 echo ""
 echo " <study_folder>/<case>/hcp/<case>/MNINonLinear"
 echo ""
 echo "INPUTS"
 echo "======"
 echo ""
 ...
 echo "--infolder          Input HCP folder where minimally preprocessed results "
 echo "                    reside [<path_to_study_sessions_folder>/<session_id>/hcp]"
 echo "-outfolder          Output folder for probtrackX results."
 echo "                    [<path_to_study_sessions_folder>/<session_id>/hcp/<session_id>/MNINonLinear/Results/Tractography]"
 ...
 echo ""
 echo "   <study_folder>/<case>/hcp/<case>/MNINonLinear/Results/Conn1.dconn.nii.gz"
 echo ""
 echo "Dense Connectome CIFTI Results in MNI space for Matrix3 will be here::"
 echo ""
 echo "   <study_folder>/<case>/hcp/<case>/MNINonLinear/Results/Conn3.dconn.nii.gz"
 echo ""
 echo "USE"
 echo "==="
 echo ""
