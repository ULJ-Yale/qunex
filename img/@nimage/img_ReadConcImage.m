function [img] = img_ReadConcImage(file, dtype, frames, verbose)
...
%
%   OUTPUT
%       img  - a concatenated nimage object.
%
%   USE
...
%
%   EXAMPLE USE
%   >>> concimage = nimage.img_ReadConcImage('OP234-WM.conc');
%
%   Indirect use:
...
file = strtrim(file);
files = nimage.img_ReadConcFile(file);
nfiles = length(files);
