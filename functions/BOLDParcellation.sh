...
usage() {
     ...
     echo "-- EXAMPLES:"
     echo ""
     echo "   --> Run directly via ${TOOLS}/${QUNEXREPO}/connector/functions/BOLDParcellation.sh --<parameter1> --<parameter2> --<parameter3> ... --<parameterN> "
     echo ""
     reho "           * NOTE: --scheduler is not available via direct script call."
     echo ""
     echo "   --> Run via qunex BOLDParcellation --<parameter1> --<parameter2> --<parameter3> ... --<parameterN> "
     echo ""
