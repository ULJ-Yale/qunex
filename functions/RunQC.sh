...
usage() {
    ...
    echo ""
    echo ""
    echo " -- Full call specification:"
    echo " qunex runQC \ "
    echo "--path='<path_to_study_folder>' \ "
    ...
    echo "--datapath=<path_for_general_scene> \ "
    echo "--datafile=<data_input_for_general_scene> \ "
    echo "--customqc=<yes/no> \ "
    echo "--omitdefaults=<yes/no> \ "
    echo "--dwipath='<path_for_dwi_data>' \ "
    echo "--dwidata='<file_name_for_dwi_data>' \ "
    echo "--dwilegacy='<yes/no>' \ "
    echo "--dtifitqc='<visual_qc_for_dtifit>' \ "
    echo "--bedpostxqc='<visual_qc_for_bedpostx>' \ "
    echo "--eddyqcstats='<qc_stats_for_eddy>' \ "
    echo "--bolddata='<bold_run_numbers>' \ "
    echo "--boldprefix='<prefix_file_name_for_bold_data>' \ "
    echo "--boldsuffix='Atlas' \ "
    echo "--skipframes='<number_of_initial_frames_to_discard_for_bold_qc>' \ "
    echo "--snronly='<compute_snr_only_for_bold>' \ "
    echo "--timestamp='<specify_time_stamp>' \ "
    echo "--scenezip='yes' \ "
    echo "--boldfc='<pscalar_or_pconn>' \ "
    echo "--boldfcinput='<data_input_for_bold_fc>' \ "
    echo "--boldfcpath='<path_for_bold_fc>' \ "
    echo "--suffix='<specify_suffix_id_for_logging>' \ "
    echo "--hcp_suffix='<specify_suffix_for_hcp_folder_name>' \ "
