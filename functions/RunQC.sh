...
usage() {
 ...
 echo "                       time stamp from connector wrapper"
 echo "--suffix               Allows user to specify unique suffix or to parse a time "
 echo "                       stamp from connector wrapper."
 ...
 echo ""
 echo " ${TOOLS}/${QUNEXREPO}/connector/functions/RunQC.sh \ "
 ...
 echo "Run via:: "
 echo ""
 echo " qunex runQC --<parameter1> --<parameter2> ... --<parameterN> "
 echo ""
