...
if [[ -z ${FSL_FIXDIR} ]]; then FSL_FIXDIR="${FSLDIR}/bin"; fi
if [[ -z ${LEGACY_FIXDIR} ]]; then LEGACY_FIXDIR="${TOOLS}/fsl/fix"; fi
...
qx_echo "                     Murray Lab, Dartmouth College"
echo ""
...
# -- ICA FIX path
PATH=${FSL_FIXDIR}:${LEGACY_FIXDIR}:${PATH}
export FSL_FIXDIR LEGACY_FIXDIR PATH
MATLABPATH=$FSL_FIXDIR:$LEGACY_FIXDIR:$MATLABPATH
export MATLABPATH
