function stats = mri_ExtractROIStats(obj, roi, rcodes, selection, frames, weight, criterium)
...
%   weight          - image file with weights to use for either selection of weighted mean computation []
%   criterium       - threshold or number of voxels to extract []
%
%
%   Grega Repovš, 2015-12-09 ... Adapted from existing mri_ExtractROI method.
%
%   ToDo
