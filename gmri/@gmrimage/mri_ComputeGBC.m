...
%
%   OUTPUT
%       obj      - The resulting gmrimage object with as many frames as there were commands given.
...
%   values or a gmrimage object storing the same values. It has to match the number of voxels in the original
%   image.
%
