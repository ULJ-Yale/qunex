...
%                  function (the function currently supports only input ROI
%                  reports from ROI analyses on single frame images)
%   --fin          input image file name (fin can have multiple frames)
%   --fout         output file name ['outputPeakValues.txt']
%
%   EXAMPLE USE
%   ===========
%   
%   An example call where ROI_report.txt is the output file from
%   general_find_peaks function::
%
%       general_get_peak_values('ROI_report.txt',...
%       'input_image.dscalar.nii',
%       'ROI_values.txt');
%
