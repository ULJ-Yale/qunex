...
%
%   Notes:
%       The function looks for presence of .glm files in the specified
%       folder. It then generates an AVI movie for each of the found files,
%       each frame of the movie showing axial slices of one volume of the
%       glm file. The AVI files are saved with the same name (but different
%       extension) as the glm files in the specified folder (created if it
%       does not yet exist). The function is used to quickly inspect the
