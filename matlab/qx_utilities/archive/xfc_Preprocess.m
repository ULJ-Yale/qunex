...
if strfind(doIt, 'l')
	for n = 1:length(sfiles)
		...
		[status result] = system(['bandpass_4dfp ' char(rfiles{n}) ' ' num2str(TR) ' -bh.08 -n' num2str(omit) ' -oh2 -E -tbpss ']);
		if ~status
